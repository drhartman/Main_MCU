...
;******************************************************************************
	...
	EXTERN	PORTBIntHandler
	EXTERN	PORTFIntHandler
	EXTERN	UART2IntHandler
	EXTERN	UART3IntHandler
	EXTERN	UART4IntHandler
	EXTERN	UART5IntHandler
	EXTERN	UART6IntHandler
	EXTERN	UART7IntHandler
...
__Vectors
        ...
        DCD     PORTBIntHandler           ; GPIO Port B
        ...
        DCD     UART4IntHandler           ; UART4 Rx and Tx
        DCD     UART5IntHandler           ; UART5 Rx and Tx
        DCD     UART6IntHandler           ; UART6 Rx and Tx
        DCD     UART7IntHandler           ; UART7 Rx and Tx
        DCD     0                           ; Reserved
        DCD     0                           ; Reserved
        DCD     0                           ; Reserved
        DCD     0                           ; Reserved
